...
import { cosmeticReference, figurePath, inspectPart, validateFigure } from "../../src/figure/manifest.ts";
import type { FigureManifest } from "../../src/figure/manifest.ts";
import { inspectCosmetic, placementTransform, resolveCosmeticPlacements, validateWardrobeSet } from "../../src/wardrobe/placement.ts";
import type { CosmeticPiece, CosmeticPlacement, WardrobeSet } from "../../src/wardrobe/placement.ts";
