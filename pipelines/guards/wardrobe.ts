...
import { inspectCosmetic, resolveCosmeticPlacements, validateWardrobeSet } from "../../src/wardrobe/placement.ts";
import type { CosmeticPlacement, WardrobeSet } from "../../src/wardrobe/placement.ts";
...
function jsonFiles(directory: string): string[] {
  return readdirSync(directory).filter((name) => name.endsWith(".json") && name !== "index.json").sort();
}
