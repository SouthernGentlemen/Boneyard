...
export const DECLARED_ENTRY_RULES: readonly DeclaredEntryRule[] = [
  ...
  { pattern: "rigs/footprint.baseline.json", reason: "committed byte ratchet input" },
  { pattern: "catalog/clips.json", reason: "generated clip catalog read by every consuming lab" },
  { pattern: "figures/index.json", reason: "generated figure discovery index read by every consuming lab" },
  { pattern: "cosmetics/index.json", reason: "generated wardrobe discovery index read by every consuming lab" },
];
