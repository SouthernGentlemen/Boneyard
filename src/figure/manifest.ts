...
/** The generated discovery index sits beside the manifests it lists and is not one of them. */
export const INDEX_FILE = "index.json";

export function isFigureManifestFile(name: string): boolean {
  return name.endsWith(".json") && name !== INDEX_FILE;
}
