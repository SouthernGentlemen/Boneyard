...
import { cosmeticFit, inspectCosmetic, resolveCosmetic, resolveCosmeticPlacements } from "../../src/wardrobe/placement.ts";
import type { WardrobeSet } from "../../src/wardrobe/placement.ts";
